...
export default function ProjectSection({ project }: ProjectSectionProps) {
  ...
  useEffect(() => {
    ...
    }, wrapperRef); // Use wrapperRef as context scope
        ...
        <div ref={containerRef} className="relative h-full w-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-8 md:p-16 lg:p-24">
            <div className="relative aspect-4/5 h-full max-h-[80vh] w-auto overflow-hidden bg-zinc-100 dark:bg-zinc-900 shadow-2xl">
              ...
              {/* Image 2: Detail */}
              <div ref={img2Ref} className="absolute inset-0 z-20 opacity-0 scale-105 bg-zinc-200 dark:bg-zinc-800">
                <div className="flex h-full w-full items-center justify-center text-zinc-400">
              ...
              {/* Image 3: Raum */}
              <div ref={img3Ref} className="absolute inset-0 z-30 opacity-0 scale-105 bg-white dark:bg-black">
                <div className="flex h-full w-full items-center justify-center text-zinc-400">
          ...
          {/* Text Overlay */}
          <div ref={textRef} className="pointer-events-none absolute bottom-12 left-12 z-40 max-w-sm md:bottom-24 md:left-24">
            ...
            <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400">{project.description}</p>
